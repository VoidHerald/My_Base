...
function chTextOnImg(){
    document.getElementById('div4').innerHTML="<img src='3.gif'  width='100px' height='100px'>"
}
function chSizOfImg1(el){
    el.width=1200;
}
function chSizOfImg2(el){
    el.width=100;
}
function chSizOfImg3(){
    document.getElementById('divlast').innerHTML="<div class='cl3'>ggggggggggggggggggggggggggggggggggggggggggggggggg</div>"
}
